...
package com.yq.zxingtest.zxing.decoding;
...
import com.yq.zxingtest.R;
import com.yq.zxingtest.zxing.camera.CameraManager;
import com.yq.zxingtest.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(DecodeHandlerInterface handlerInterface,
        ...
        decodeThread = new DecodeThread(handlerInterface, decodeFormats, characterSet, new ViewfinderResultPointCallback(handlerInterface.getViewfinderView()));
        decodeThread.start();
        state = State.SUCCESS;
